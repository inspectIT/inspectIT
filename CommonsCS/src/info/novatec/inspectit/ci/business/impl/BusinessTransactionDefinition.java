...
public class BusinessTransactionDefinition {
	/**
	 ...
	 *
	 * @return Returns the {@link AbstractExpression} for this business transaction.
	 */
	...
	/**
	 * Sets the {@link AbstractExpression} for this business transaction.
	 *
	 * @param matchingRuleExpression
	...
	/**
	 * Creates identifier for a business transaction using the {@link ApplicationDefinition#id} and
	 * the passed dynamicBusinessTransactionName.
	 *
	 * @param businessTransactionName
	 *            the name of the business transaction
	 *
	 * @return id for business transaction instance.
	 */
	public int createBusinessTransactionId(String businessTransactionName) {
		return businessTransactionName.hashCode() + 7 * hashCode();
	}
