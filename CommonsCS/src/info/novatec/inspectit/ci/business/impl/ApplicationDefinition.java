...
public class ApplicationDefinition {
	 ...
	 */
	@XmlElementRef(type = BusinessTransactionDefinition.class)
	private final BusinessTransactionDefinition defaultBusinessTxDefinition = DEFAULT_BUSINESS_TRANSACTION_DEFINITION;
	 ...
	 *
	 * @return Returns the {@link AbstractExpression} for this application.
	 */
	...
	/**
	 * Sets the {@link AbstractExpression} for this application.
	 *
	 * @param matchingRuleExpression
	...
	public int createApplicationId() {
		return getApplicationName().hashCode() + 7 * hashCode();
	}
