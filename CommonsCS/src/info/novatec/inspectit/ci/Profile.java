...
public class Profile {
	 ...
	 */
	// @XmlElementWrapper(name = "method-sensor-assignments", required = false)
	 ...
	 */
	// @XmlElementWrapper(name = "exception-sensor-assignments", required = false)
	 ...
	 * {@link ExcludeRule}s.
	 */
	// @XmlElementWrapper(name = "exclude-rules", required = false)
