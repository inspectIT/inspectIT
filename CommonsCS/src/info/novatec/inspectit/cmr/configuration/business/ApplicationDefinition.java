...
public class ApplicationDefinition implements IApplicationDefinition {
	 ...
	 */
	@XmlElement(type = MatchingRule.class)
	 ...
	 */
	@XmlElement(name = "default-business-transaction", type = BusinessTransactionDefinition.class)
	 ...
	 */
	protected ApplicationDefinition(long id, String applicationName, IMatchingRule matchingRule) {
