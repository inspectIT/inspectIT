...
public class AndExpressionTest extends TestBase {
	...
	public static class Evaluate extends AndExpressionTest {
		...
		public void noOperand() {
			assertThat(andExpression.evaluate(invocation, cachedDataService), is(true));
		}

		@Test
		public void oneOperandTrue() {
			when(expr_1.evaluate(invocation, cachedDataService)).thenReturn(true);
			andExpression.getOperands().add(expr_1);
		...
		public void oneOperandFalse() {
			...
			assertThat(andExpression.evaluate(invocation, cachedDataService), is(false));
		}
		...
		public void twoOperandsTrue() {
			...
			andExpression.getOperands().add(expr_2);
		...
		public void threeOperandsTrue() {
			...
			andExpression.getOperands().add(expr_3);
