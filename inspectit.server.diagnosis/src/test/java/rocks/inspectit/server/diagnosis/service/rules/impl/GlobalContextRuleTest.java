...
public class GlobalContextRuleTest extends TestBase {
	...
	public static class Action extends GlobalContextRuleTest {
		...
		@Test
		private void currentGlobalContextRuleMustBeTheSequenceWithMaximumDuration() throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
