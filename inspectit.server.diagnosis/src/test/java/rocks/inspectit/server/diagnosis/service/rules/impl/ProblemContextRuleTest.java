...
public class ProblemContextRuleTest extends TestBase {
	...
	public static class Action extends ProblemContextRuleTest {
		...
		public void problemContextMustBeTheMostSignificantClusterContext() {
			...
			InvocationSequenceData firstSeqWithParent = new InvocationSequenceData(defDate, platformIdent, sensorTypeIdent, methodIdent);
			...
			InvocationSequenceData secondRawInvocation = new InvocationSequenceData(defDate, platformIdent, sensorTypeIdent, methodIdent);
			timerData.setExclusiveDuration(2000d);
			secondRawInvocation.setTimerData(timerData);
			secondRawInvocation.setParentSequence(globalContext);
			InvocationSequenceData secondSeqWithParent = new InvocationSequenceData(defDate, platformIdent, sensorTypeIdent, methodIdent);
