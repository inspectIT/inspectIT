...
public class DiagnosisDataAggregationPerformer {
	...
	/**
	 * Instance of the {@link DiagnosisDataAggregator}.
	 */
	private static final DiagnosisDataAggregator DIAGNOSIS_DATA_AGGREGATOR = DiagnosisDataAggregator.getInstance();
