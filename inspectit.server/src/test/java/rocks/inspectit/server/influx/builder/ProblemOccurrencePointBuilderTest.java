...
public class ProblemOccurrencePointBuilderTest extends TestBase {
	...
	public static class SaveProblemOccurrenceToInflux extends ProblemOccurrencePointBuilderTest {
		...
		@Test
		public void mustCallGetBuilder() {
			...
			problemOccurrencePointBuilder = spy(problemOccurrencePointBuilder);

			Builder builder = problemOccurrencePointBuilder.getBuilder(problemOccurrence);

			verify(problemOccurrencePointBuilder, times(1)).addTags(problemOccurrence, builder);
			verify(problemOccurrencePointBuilder, times(1)).addFields(problemOccurrence, builder);
		}
	}
}
