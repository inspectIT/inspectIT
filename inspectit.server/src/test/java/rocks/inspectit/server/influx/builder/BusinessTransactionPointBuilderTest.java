...
public class BusinessTransactionPointBuilderTest extends AbstractPointBuilderTest {
	...
	public class CreateBuilder extends BusinessTransactionPointBuilderTest {
		...
		public void happyPath() throws Exception {
			...
			assertThat(getTags(pointBuilder), hasEntry(Tags.APPLICATION_NAME, String.valueOf(APP_NAME)));
			assertThat(getTags(pointBuilder), hasEntry(Tags.BUSINESS_TRANSACTION_NAME, String.valueOf(BT_NAME)));
		...
		public void noBusinessContext() throws Exception {
			...
			assertThat(getTags(pointBuilder), hasEntry(Tags.AGENT_ID, String.valueOf(PLATFORM_ID)));
			assertThat(getTags(pointBuilder), hasEntry(Tags.AGENT_NAME, String.valueOf(AGENT_NAME)));
			assertThat(getTags(pointBuilder), hasEntry(Tags.APPLICATION_NAME, String.valueOf(ApplicationDefinition.UNKNOWN_APP)));
			assertThat(getTags(pointBuilder), hasEntry(Tags.BUSINESS_TRANSACTION_NAME, String.valueOf(BusinessTransactionDefinition.UNKNOWN_BUSINESS_TX)));
			assertThat(getFields(pointBuilder), hasEntry(Series.BusinessTransaction.FIELD_DURATION, (Object) duration));
		}
