...
public class ThreadInformationPointBuilderTest extends AbstractPointBuilderTest {
	...
	public class CreateBuilder extends ThreadInformationPointBuilderTest {
		...
		public void happyPath() throws Exception {
			...
			assertThat(getFields(pointBuilder), hasEntry(Series.ThreadInformation.FIELD_DEAMON_THREAD_COUNT, (Object) (long) (data.getTotalDaemonThreadCount() / data.getCount())));
			assertThat(getFields(pointBuilder), hasEntry(Series.ThreadInformation.FIELD_LIVE_THREAD_COUNT, (Object) (long)(data.getTotalThreadCount() / data.getCount())));
			assertThat(getFields(pointBuilder), hasEntry(Series.ThreadInformation.FIELD_PEAK_THREAD_COUNT, (Object) (long) (data.getTotalPeakThreadCount() / data.getCount())));
