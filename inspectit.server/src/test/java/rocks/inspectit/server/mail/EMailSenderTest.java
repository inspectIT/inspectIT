...
public class EMailSenderTest extends TestBase {
	...
	public static class InitAndOnSmtpPropertiesChanged extends EMailSenderTest {
		...
		public void successfully() throws Exception {
			...
			assertThat(mailSender.getAdditionalProperties().entrySet(), hasSize(2));
			assertThat(mailSender.getAdditionalProperties(), hasEntry((Object) "key1", (Object) "val1"));
			assertThat(mailSender.getAdditionalProperties(), hasEntry((Object) "key2", (Object) "val2"));
			assertThat(mailSender.getDefaultRecipients(), hasSize(2));
			assertThat(mailSender.getDefaultRecipients(), hasItems("one@example.com", "two@example.com"));
		}
		...
		public void recipientsAndPopertiesAreNull() throws Exception {
			...
			assertThat(mailSender.isConnected(), is(true));
			assertThat(mailSender.getAdditionalProperties().entrySet(), hasSize(0));
			assertThat(mailSender.getDefaultRecipients(), hasSize(0));
		}
