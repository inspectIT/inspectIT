...
public class RemoveAllInstrumentationApplierTest extends TestBase {
	...
	public static class AddInstrumentationPoints extends RemoveAllInstrumentationApplierTest {
		...
		public void nullConfig() {
			boolean result = applier.addInstrumentationPoints(null, classType);
		...
		public void nullClass() {
			boolean result = applier.addInstrumentationPoints(agentConfiguration, null);
		...
		public void nullParameters() {
			boolean result = applier.addInstrumentationPoints(null, null);
