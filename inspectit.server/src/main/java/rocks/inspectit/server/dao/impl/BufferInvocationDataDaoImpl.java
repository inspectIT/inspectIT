...
public class BufferInvocationDataDaoImpl extends AbstractBufferDataDao<InvocationSequenceData> implements InvocationDataDao {
	 ...
	 */
	@Override
	public List<InvocationSequenceData> getInvocationSequenceOverview(Long platformId, Date startDate, Date endDate, long minId, int limit, int businessTrxId, int applicationId, // NOCHK
