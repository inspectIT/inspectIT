...
public interface InvocationDataDao {
	 ...
	 * @return Returns the list of invocation sequences.
	 */
	List<InvocationSequenceData> getInvocationSequenceOverview(Long platformId, Date startDate, Date endDate, long minId, int limit, int businessTrxId, int applicationId, // NOCHK
