...
public class ConfigurationInterfaceManager {
	...
	/**
	 * Returns the bytes for the given {@link ConfigurationInterfaceExportData}. These bytes can be
	 * saved directly to export file.
	 *
	 * @param exportData
	 *            {@link ConfigurationInterfaceExportData}.
	 * @return Byte array.
	 * @throws IOException
	 ...
	 */
	public byte[] getExportData(ConfigurationInterfaceExportData exportData) throws JAXBException, IOException {
		return transformator.marshall(exportData, null);
	}

	/**
	 * Returns the {@link ConfigurationInterfaceExportData} from the given import data bytes.
	 *
	 * @param importData
	 *            bytes that were exported.
	 * @return {@link ConfigurationInterfaceExportData}.
	 * @throws SAXException
	 ...
	 */
	public ConfigurationInterfaceExportData getImportData(byte[] importData) throws JAXBException, IOException, SAXException {
		return transformator.unmarshall(importData, pathResolver.getSchemaPath(), ConfigurationInterfaceExportData.class);
	}
