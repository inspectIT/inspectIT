...
public final class AlertingUtils {
	...
	public static boolean isBusinessTransactionAlert(AlertingDefinition alertingDefinition) {
		return alertingDefinition.getMeasurement().equals(Series.BusinessTransaction.NAME) && alertingDefinition.getField().equals(Series.BusinessTransaction.FIELD_DURATION);
	}
