...
public class ConfigurationResolver {
	...
	public String getConfigurationInfo(Environment environment) {
		...
		if (eumConfig.isEumEnabled()) {
			stringBuilder.append("End User Monitoring is enabled.\n"); // NOPMD
			stringBuilder.append("EUM beacon URL: " + eumConfig.getScriptBaseUrl() + JSAgentModule.BEACON_SUB_PATH + "\n"); // NOPMD
			stringBuilder
			.append("EUM JS Agent URL: " + eumConfig.getScriptBaseUrl() + JSAgentModule.JAVASCRIPT_URL_PREFIX + JSAgentModule.JS_AGENT_REVISION + "_" + eumConfig.getActiveModules()
			+ ".js"); // NOPMD
		} else {
			stringBuilder.append("End User Monitoring is disabled.\n"); // NOPMD
		}
