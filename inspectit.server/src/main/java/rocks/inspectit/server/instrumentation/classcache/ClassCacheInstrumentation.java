...
import rocks.inspectit.shared.all.instrumentation.config.impl.AgentConfiguration;
...
import rocks.inspectit.shared.cs.instrumentation.config.applier.RemoveAllInstrumentationApplier;
 ...
 * {@link #addAndGetInstrumentationResult(ImmutableClassType, AgentConfiguration, Collection)} method for easy add/get
...
public class ClassCacheInstrumentation {
	 ...
	 *         <code>null</code>.
	 */
	public InstrumentationDefinition addAndGetInstrumentationResult(final ImmutableClassType type, final AgentConfiguration agentConfiguration, final Collection<IInstrumentationApplier> appliers) {
