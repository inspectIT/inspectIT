...
public interface IInstrumenterConstant {
	 ...
	 */
	String AGENT_INTERNAL_NAME = "info/novatec/inspectit/agent/Agent";

	/**
	 * Internal name of our IAgent.
	 */
	String IAGENT_INTERNAL_NAME = "info/novatec/inspectit/agent/IAgent";

	/**
	 * Internal name of our IHookDispatcher.
	 */
	String IHOOK_DISPATCHER_INTERNAL_NAME = "info/novatec/inspectit/agent/hooking/IHookDispatcher";
