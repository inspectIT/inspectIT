...
public abstract class AbstractMethodInstrumenter extends AdviceAdapter {
	 ...
	 */
	protected static final String IHOOK_DISPATCHER_INTERNAL_NAME = "info/novatec/inspectit/agent/hooking/IHookDispatcher";

	/**
	 * Internal name of get IHookDispatcher method.
	 */
	private static final String GET_IHOOK_DISPATCHER_DESCRIPTOR = "()L" + IHOOK_DISPATCHER_INTERNAL_NAME + ";";
