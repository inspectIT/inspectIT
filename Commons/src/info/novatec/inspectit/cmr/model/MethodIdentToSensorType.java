 ...
 */
@Table(indexes = { 
		@Index(name = "method_ident_to_sensor_type_idx", columnList = "methodIdent"), 
		@Index(name = "method_ident_to_sensor_type_idx", columnList = "methodSensorTypeIdent") })
...
public class MethodIdentToSensorType implements Serializable {
	...
	@SequenceGenerator(name = "METHOD_SENSOR_SEQUENCE", sequenceName = "METHOD_SENSOR_SEQUENCE", allocationSize = 1)
	private Long id;
