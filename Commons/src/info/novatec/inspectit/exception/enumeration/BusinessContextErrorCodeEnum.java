...
public enum BusinessContextErrorCodeEnum implements IErrorCode {
	 ...
	 */
	INVALID_MOVE_OPRATION("The move operation cannot is invalid.", "The target index of the move operation is invalid.", "Check whether the target of the move operation is within the valid range."),
