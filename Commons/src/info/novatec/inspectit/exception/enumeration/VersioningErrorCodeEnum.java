...
public enum VersioningErrorCodeEnum implements IErrorCode {
	...
	VERSION_FILE_IO("The version file version.log cannot be found or read.", "The version file might be deleted.", "Contact inspectIT Support."),

	/** No version in file. */
	VERSION_NOT_IN_FILE("The version file version.log does not contain a version.", null, "Contact inspectIT Support."),

	/** Invalid version. */
	VERSION_INVALID("The version of inspectIT has an invalid format.", null, "Contact inspectIT Support.");
