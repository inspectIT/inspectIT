...
public class LoggingDetailsGenerator implements IDetailsGenerator {
	...
	public DetailsTable generate(DefaultData defaultData, RepositoryDefinition repositoryDefinition, Composite parent, FormToolkit toolkit) {
		...
		table.addContentRow("Level:", null, new DetailsCellContent[] { new DetailsCellContent(loggingData.getLevel()) });
		table.addContentRow("Message:", null, new DetailsCellContent[] { new DetailsCellContent(loggingData.getMessage()) });
		return table;
	}
