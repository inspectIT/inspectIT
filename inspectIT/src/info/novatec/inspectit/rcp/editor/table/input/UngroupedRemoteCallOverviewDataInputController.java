...
import info.novatec.inspectit.communication.comparator.RemoteCallDataComparatorEnum;
...
public class UngroupedRemoteCallOverviewDataInputController extends AbstractTableInputController {
	...
	private static enum Column {
		...
		/** The method column. */
		CALLING("Calling", 100, InspectITImages.IMG_METHOD_PUBLIC, RemoteCallDataComparatorEnum.IS_CALLING),
		/** The method column. */
		IDENTIFICATION("Identification", 150, InspectITImages.IMG_METHOD_PUBLIC, RemoteCallDataComparatorEnum.IDENTIFICATION),
		/** The method column. */
		URL("URL", 550, InspectITImages.IMG_METHOD_PUBLIC, RemoteCallDataComparatorEnum.IDENTIFICATION),
		/** The method column. */
		RESPONSECODE("Response Code", 100, InspectITImages.IMG_METHOD_PUBLIC, RemoteCallDataComparatorEnum.IDENTIFICATION);
