...
import info.novatec.inspectit.rcp.tester.JmxSensorValueDataTester;
...
public class JmxSensorDataInputController extends AbstractTableInputController {
	...
	private final class LabelProvider extends StyledCellIndexLabelProvider {
		...
		/**
		 * Tester to test the {@link JmxSensorValueData} whether it can be charted.
		 */
		private JmxSensorValueDataTester canChartDataTester = new JmxSensorValueDataTester();
		...
		protected Image getColumnImage(Object element, int index) {
			...
			case CHARTING:
				if (canChartDataTester.test(data, "canChart", null, null)) {
