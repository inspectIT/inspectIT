...
public class JmxSensorDataInputController extends AbstractTableInputController {
	...
	private static enum Column {
		...
		TIMESTAMP("Timestamp", 100, InspectITImages.IMG_TIMER, JmxDataComparatorEnum.TIMESTAMP),
	...
	public void doRefresh(IProgressMonitor monitor, IRootEditor rootEditor) {
		...
		List<JmxSensorValueData> data = (List<JmxSensorValueData>) jmxDataAccessService.getJmxDataOverview(template);
