...
public final class PlotDataSolverFactory {
	...
	/**
	 * Returns a {@link AbstractPlotDataSolver} implementation of the given {@link EPlotDataSolver}. There
	 * is only one instance of each dataSolver which is stored in the {@link #dataSolverMap}. If
	 * there is no instance of the desired implementation, a new one is created and stored in the
	 * map.
	 * 
	 * @param dataSolver
	 ...
	 */
	private static synchronized PlotDataSolverFactory instance() {
		if (null == singleton) {
	...
	/**
	 * Returns the default implementation of the {@link AbstractPlotDataSolver} interface. Equals to a call
	 * of the {@link #getDataSolver(EPlotDataSolver)} method with parameter
