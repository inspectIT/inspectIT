...
import info.novatec.inspectit.rcp.editor.text.input.JmxInputController;
...
public final class SubViewFactory {
	...
	public static ISubView createSubView(SensorTypeEnum sensorTypeEnum) {
		...
		case CHARTING_JMX_SENSOR_DATA:
			...
			JmxInputController jmxInputController = new JmxInputController();
			...
			jmxChartSashSubView.addSubView(jmxGraphSubView, 2);
			jmxChartSashSubView.addSubView(jmxTextSubView, 1);
