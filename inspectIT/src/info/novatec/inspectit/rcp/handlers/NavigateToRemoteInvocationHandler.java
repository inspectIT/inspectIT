...
import info.novatec.inspectit.rcp.editor.inputdefinition.extra.RemoteInvocationInputDefinitionExtra;
...
public class NavigateToRemoteInvocationHandler extends AbstractTemplateHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (!remoteDataList.isEmpty()) {
			...
			editorPropertiesData.setViewName("that contain " + "Remoties");
