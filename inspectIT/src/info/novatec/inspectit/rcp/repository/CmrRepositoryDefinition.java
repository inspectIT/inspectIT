...
public class CmrRepositoryDefinition implements RepositoryDefinition, ICmrRepositoryProvider {
	...
	/**
	 * Cache updater for the {@link #cachedDataService}.
	 */
	private final CachedDataServiceUpdater cachedDataServiceUpdater;
	...
	public CmrRepositoryDefinition(String ip, int port, String name) {
		...
		cachedDataServiceUpdater = new CachedDataServiceUpdater(cachedDataService);
	}
	...
	/**
	 * Gets {@link #cachedDataServiceUpdater}.
	 *
	 * @return {@link #cachedDataServiceUpdater}
	 */
	public CachedDataServiceUpdater getCachedDataServiceUpdater() {
		return cachedDataServiceUpdater;
	}
}
