...
import info.novatec.inspectit.rcp.ci.view.ConfigurationInterfaceManagerView.OpenEnvironmentJob;
	...
	public boolean performFinish() {
		...
		if (cmrRepositoryDefinition.getOnlineStatus() != OnlineStatus.OFFLINE) {
			try {
				...
				InspectIT.getDefault().getInspectITConfigurationInterfaceManager().environmentAdded(created, cmrRepositoryDefinition);
