...
public class CaptureContextDialog extends TitleAreaDialog implements IControlValidationListener {
	...
	private Button returnButton; // NOCHK
	private Button parameterButton; // NOCHK
	private Button fieldButton; // NOCHK
	private Text nameText; // NOCHK
	private Text accessorText; // NOCHK
	private Button addPath; // NOCHK
	private Button clearPaths; // NOCHK
	private Label indexLabel; // NOCHK
	private Text indexText; // NOCHK
	private Label fieldLabel; // NOCHK
	private Text fieldText; // NOCHK
	...
	protected Control createDialogArea(Composite parent) {
		...
		final ValidationControlDecoration<Text> fieldValidation = new ValidationControlDecoration<Text>(fieldText, this) {
			@Override
			protected boolean validate(Text control) {
		...
		ValidationControlDecoration<Text> nameValidation = new ValidationControlDecoration<Text>(nameText, this) {
			@Override
			protected boolean validate(Text control) {
				return StringUtils.isNotBlank(control.getText());
			}
