...
public final class MatchingRulesEditingElementFactory {
	 ...
	 */
	private static AbstractRuleEditingElement<?> createRuleComposite(MatchingRuleType type, StringMatchingExpression expression, boolean editable, IValidatorRegistry validatorRegistry) {
	 ...
	 * @return Returns an {@link AbstractRuleEditingElement} instance.
	 */
	private static AbstractRuleEditingElement<?> createRuleComposite(BooleanExpressionType type, BooleanExpression expression, boolean editable, IValidatorRegistry validatorRegistry) {
		if (expression == null) {
