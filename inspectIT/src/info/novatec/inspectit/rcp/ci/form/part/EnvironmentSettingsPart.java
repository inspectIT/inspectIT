...
public class EnvironmentSettingsPart extends SectionPart implements IPropertyListener {
	...
	public EnvironmentSettingsPart(FormPage formPage, Composite parent, FormToolkit toolkit, int style) {
		...
		getSection().setDescription("Define sending and buffer strategies");
	...
	private void createClient(Section section, FormToolkit toolkit) {
		...
		sendingValue.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false));
		createInfoLabel(
				mainComposite,
				toolkit,
		...
		bufferValue.setLayoutData(new GridData(SWT.FILL, SWT.FILL, false, false));
		createInfoLabel(
				mainComposite,
				toolkit,
		...
		// validation boxes
		sendingValueDecoration = new ValidationControlDecoration<Text>(sendingValue) {
			@Override
		...
		bufferValueDecoration = new ValidationControlDecoration<Text>(bufferValue) {
			@Override
			protected boolean validate(Text control) {
