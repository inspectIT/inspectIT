...
public class TimerSensorAssignmentDetailsPage extends MethodSensorAssignmentDetailsPage {
	...
	public void createContents(Composite parent) {
		...
		final ValidationControlDecoration<Table> nonEmptyCaptureContextDecoration = new ValidationControlDecoration<Table>(captureContextTable, null, this) {
			@Override
		...
		nonEmptyCaptureContextDecoration.registerListener(captureContextButton, SWT.Selection);
		nonEmptyCaptureContextDecoration.registerListener(addCaptureButton, SWT.Selection);
		nonEmptyCaptureContextDecoration.registerListener(removeCaptureButton, SWT.Selection);
