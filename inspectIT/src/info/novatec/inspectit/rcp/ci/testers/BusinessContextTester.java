...
public class BusinessContextTester extends PropertyTester {
	...
	public boolean test(Object receiver, String property, Object[] args, Object expectedValue) {
		...
		if (receiver instanceof BusinessTransactionDefinition) {
			...
			} else if (CAN_MOVE_UP_PROPERTY.equals(property) && null != args && args.length > 0 && args[0] instanceof ApplicationDefinition) {
				return ((ApplicationDefinition) args[0]).getBusinessTransactionDefinitions().indexOf(businessTransactionDef) > 0;
			} else if (CAN_MOVE_DOWN_PROPERTY.equals(property) && null != args && args.length > 0 && args[0] instanceof ApplicationDefinition) {
