...
public class ConfigurationInterfaceManagerView extends ViewPart implements IRefreshableView, CmrRepositoryChangeListener, IProfileChangeListener, IEnvironmentChangeListener {
	...
	public void createPartControl(Composite parent) {
		...
		//TODO: This needs to be removed as soon as the configuration interface is fully functional.
		UnfinishedWarningUtils.inform("The configuration interface is not yet connected with the agent instrumentation. You can play around with this preview, but the instrumentations will not be effective. One of the next versions integrate this configuration interface together with the new approach on instrumentation on the agent.", "UNFINISHED_WARNING_CONFIGURATION_INTERFACE");
	}
