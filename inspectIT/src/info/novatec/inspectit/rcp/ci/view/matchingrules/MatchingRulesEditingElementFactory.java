...
public final class MatchingRulesEditingElementFactory {
	 ...
	 *
	 * @param expression
	 *            {@link Expression} determining the {@link AbstractRuleEditingElement} instance.
	 * @return Returns {@link Expression} instance, or {@code null} if no {@link Expression}
	 *         instance can be created for the passed {@link Expression}.
	 *
	 */
	public static AbstractRuleEditingElement createRuleComposite(Expression expression) {
		if (expression instanceof StringMatchingExpression && ((StringMatchingExpression) expression).getStringValueSource() instanceof HttpUriValueSource) {
			...
			return createRuleComposite(MatchingRuleType.METHOD_SIGNATURE);
			...
			return createRuleComposite(MatchingRuleType.IP);
		}
		return null;
	}
