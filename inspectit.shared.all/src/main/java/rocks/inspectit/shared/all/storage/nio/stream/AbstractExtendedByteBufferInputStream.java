...
public abstract class AbstractExtendedByteBufferInputStream extends ByteBufferInputStream {
	...
	/**
	 * Boolean for flagging that in some way reading has failed. Sub-classes must set this to true
	 * when data could not be provided anymore (stream reached end for example).
	 */
