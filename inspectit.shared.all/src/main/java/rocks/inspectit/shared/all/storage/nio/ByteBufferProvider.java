...
public class ByteBufferProvider extends GenericObjectPool<ByteBuffer> implements InitializingBean {
	...
	protected void updatePoolProperties() {
		...
		try {
			if (UnderlyingSystemInfo.JVM_PROVIDER.equals(JvmProvider.SUN) || UnderlyingSystemInfo.JVM_PROVIDER.equals(JvmProvider.ORACLE) || UnderlyingSystemInfo.JVM_PROVIDER.equals(JvmProvider.AZUL)) {
