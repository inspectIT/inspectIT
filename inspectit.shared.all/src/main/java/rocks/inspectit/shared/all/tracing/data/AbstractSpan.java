...
public abstract class AbstractSpan extends MethodSensorData implements Span {
	 ...
	 */
	@Override
	public String addTag(Tag tag, String value) {
		if (null == tags) {
			tags = new HashMap<Tag, String>(1, 1f);
		}
	 ...
	 */
	@Override
	public void addAllTags(Map<Tag, String> otherTags) {
		if (null == tags) {
			tags = new HashMap<Tag, String>(otherTags.size(), 1f);
		}
