...
public class JmxSensor implements IJmxSensor, InitializingBean, DisposableBean {
	...
	/**
	 * @Override Registers all attributes of all object names that are returned as the result of
	 *           querying with the given mBeanName on the server in the given holder.
	 *
	 * @param holder
