 ...
 * <ul>
 *    <li>early out as soon as the file is detected to be non-html (e.g. the data is image data or a xml-file)
 *    <li>detects and ignores comments in the file
 *    <li>tries to place the tag in the head tag, if it is not present the tag will be placed in the body tag
 *    <li>supports encoded character data if the encoding is given
 *    <li>avoid double-injection by checking if the string starting at the injection point matches exactly the tag to inject
 * </ul>
 *
 * @author Jonas Kunz
 */
