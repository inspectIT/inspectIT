...
public class KeepAliveManager implements InitializingBean, DisposableBean {
	...
	public void afterPropertiesSet() throws Exception {
		if (scheduledTask == null) {
			scheduledTask = coreService.getCommunicationExecutorService().scheduleAtFixedRate(keepAliveRunner, IKeepAliveService.KA_INITIAL_DELAY, IKeepAliveService.KA_PERIOD, TimeUnit.MILLISECONDS);
		}
	}
