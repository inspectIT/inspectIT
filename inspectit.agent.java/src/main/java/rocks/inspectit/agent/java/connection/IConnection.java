...
public interface IConnection {
	 ...
	 */
	AgentConfiguration register(String agentName, String version) throws ServerUnavailableException, RegistrationException, BusinessException;
	 ...
	 * @return Instrumentation definition containing method instrumentation points that should be added
	 *         for the given type.
	 * @throws ServerUnavailableException
	 *             If server to send the request to is unavailable.
	 * @throws BusinessException
