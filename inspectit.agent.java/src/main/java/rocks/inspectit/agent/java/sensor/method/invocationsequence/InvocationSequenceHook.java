	...
	public void secondAfterBody(ICoreService coreService, long methodId, long sensorTypeId, Object object, Object[] parameters, Object result, RegisteredSensorConfig rsc) {
		...
		if (null != invocationSequenceData) {
			...
			if ((methodId == invocationStartId.get().longValue()) && (0 == invocationStartIdCount.get().longValue())) {
				...
				SpanContextImpl currentSpanContext = tracer.getCurrentContext();
				if (null != currentSpanContext) {
					invocationSequenceData.setSpanIdent(SpanContextTransformer.transformSpanContext(currentSpanContext));
				}
