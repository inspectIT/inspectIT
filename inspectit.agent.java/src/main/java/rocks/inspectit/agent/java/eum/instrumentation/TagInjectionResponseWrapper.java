...
public class TagInjectionResponseWrapper implements IProxySubject {
	 ...
	 */
	private List<HeaderModificationCommand> contentLengthHeaderModifications;
	...
	public TagInjectionResponseWrapper(Object responseObject, Object cookieToSet, String tagToInject) {
		...
		contentLengthHeaderModifications = new ArrayList<HeaderModificationCommand>();
	...
	public void setContentLength(final int len) {
		contentLengthHeaderModifications.add(new HeaderModificationCommand() {
			@Override
			public void execute() {
	...
	private void commitHeaderData() {
		...
		if (isNonHtmlContentTypeSet()) {
			...
			for (HeaderModificationCommand cmd : contentLengthHeaderModifications) {
				cmd.execute();
			}
		} else {
			if (cookieToSet != null) {
