...
namespace Instrumentation {
    ...
    /**
     * This variable holds how often disable() has been called to make sure that nested disable() and reenable() calls are handled correctly.
     */
    let instrumentationStackDepth = 0;

    /**
     * Returns whether the instruemtnation has currently been disabled via disable();
     */
    ...
    /**
     * Disables the instrumentation until reenable is called();
     * This disabling allows you to use instrumented function with generating traces, for example for sending AJAX requests.
     */
    ...
    /**
     * Reenables the instrumentation after a disable() call.
     */
    ...
    /**
     * Lookup table for getting the original callback belonging to an instrumented one.
     */
