...
abstract class BeaconElement {
    /**
     * Defines the type name of this element, which is used to identify the type when decodign the beacon.
     */
    protected abstract readonly type: string;

    /**
     * Set holding the symbolic names of missing features, preventing the element fro mbeing sent.
     */
     ...
     * This for examples excludes values which are the default and tehrefore do not need to be sent.
     */
