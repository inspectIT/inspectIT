...
public class RuntimeLinkerTest extends TestBase {
	...
	RenamingClassLoader rootLoader;


	@BeforeMethod
	public void initMocks(){
		rootLoader = new RenamingClassLoader(this.getClass().getClassLoader(), "moved.", ClassToProxy.class, InterfaceToProxy.class);
	}
	...
	public static class CreateProxy extends RuntimeLinkerTest {
		...
		public void testProxyCaching() {
			linker.createProxy(CorrectProxySubject.class, new CorrectProxySubject(), rootLoader);
			linker.createProxy(CorrectProxySubject.class, new CorrectProxySubject(), rootLoader);
		...
		public void testProxyParentClassLoaderCaching() {
			linker.createProxy(CorrectProxySubject.class, new CorrectProxySubject(), rootLoader);
			linker.createProxy(CorrectProxySubject.class, new CorrectProxySubject(), new ClassLoader(rootLoader) {
			});
		...
		public void testProxyInitialization() {
			...
			Object proxy = linker.createProxy(CorrectProxySubject.class, proxySubject, rootLoader);
		...
		public void testProxyGenerationErrorHandling() {
			...
			Object proxyA = linker.createProxy(CorrectProxySubject.class, new CorrectProxySubject(), rootLoader);
			Object proxyB = linker.createProxy(CorrectProxySubject.class, new CorrectProxySubject(), rootLoader);
	...
	public static class IsProxyInstance extends RuntimeLinkerTest {
		...
		public void testProxyInstanceofCheck() {
			Object proxy = linker.createProxy(CorrectProxySubject.class, new CorrectProxySubject(), rootLoader);
