...
public class FutureCallbackProxyTest extends TestBase {
	...
	public void init() throws Exception {
		...
		Field fieldMCompleted = FutureCallbackProxy.class.getDeclaredField("mCompleted");
		...
		Field fieldMFailed = FutureCallbackProxy.class.getDeclaredField("mFailed");
		...
		Field fieldMCancelled = FutureCallbackProxy.class.getDeclaredField("mCancelled");
