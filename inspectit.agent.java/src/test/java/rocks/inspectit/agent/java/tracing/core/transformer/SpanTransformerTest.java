...
public class SpanTransformerTest extends TestBase {
	...
	public static class TransformSpan extends SpanTransformerTest {
		...
		@Test
		public void ident() {
			when(spanImpl.context()).thenReturn(new SpanContextImpl(1, 2, 3));
		...
		public void reference() {
			when(spanImpl.context()).thenReturn(new SpanContextImpl(1, 2, 3, References.FOLLOWS_FROM, Collections.<String, String> emptyMap()));
			when(spanImpl.isClient()).thenReturn(false);
