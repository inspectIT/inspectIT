 ...
 */
public class AbstractPlatformSensorTest extends AbstractLogSupport {
	...
	/** The mocked {@link PlatformSensorData}. */
	@Mock
	...
	public static class AfterPropertiesSet extends AbstractPlatformSensorTest {
		...
		void noPlatformSensorTypeConfigFound() throws Exception {
			PlatformSensorTypeConfig platformSensorTypeConfigA =
					Mockito.mock(PlatformSensorTypeConfig.class);
		...
		void initExistingPlatformSensorData() throws Exception {
			...
			PlatformSensorData platformSensorData = this.cut.getPlatformSensorData();

			verify(platformSensorData).setPlatformIdent(1337L);
			verify(platformSensorData).setSensorTypeIdent(73L);
		}
