...
public class ServletInstrumenterTest extends TestBase {
	...
	public static class InterceptRequestTest extends ServletInstrumenterTest {
		...
		public void testBeaconInterception() throws IOException {
			String beaconUrl = "http://localhost:8080" + eumConfig.getScriptBaseUrl() + "/" + ServletInstrumenter.BEACON_SUB_PATH;
		...
		public void testScriptInterception() throws IOException {
			String scriptUrl = "http://localhost:8080" + eumConfig.getScriptBaseUrl() + "/" + ServletInstrumenter.JAVASCRIPT_URL_PREFIX + eumConfig.getActiveModules() + ".js";
		...
		public void testOtherRequestsInterception() throws IOException {
			String requestUrl = "http://localhost:8080" + eumConfig.getScriptBaseUrl() + "/dontinterceptme";
	...
	public static class InstrumentResponseTest extends ServletInstrumenterTest {
