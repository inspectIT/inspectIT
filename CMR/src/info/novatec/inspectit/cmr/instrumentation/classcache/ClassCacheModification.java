...
import info.novatec.inspectit.instrumentation.classcache.TypeWithModifiers;
...
public class ClassCacheModification {
	...
	private <T extends Type> T getOrAddReferredType(T given, Events events) {
		...
		if (null == inStructure) {
			...
			// if we have same class type then return
			if (Objects.equals(inStructure.getClass(), given.getClass())) {
