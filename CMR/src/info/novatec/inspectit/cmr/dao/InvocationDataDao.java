...
public interface InvocationDataDao {
	...
	/**
	 * Returns a list of {@link InvocationSequenceData} objects from the buffer. This method is
	 ...
	 * @return Returns the list of invocation sequences.
	 */
	List<InvocationSequenceData> getInvocationSequenceOverview(long platformId);
