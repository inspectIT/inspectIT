...
public interface InvocationDataDao {
	 ...
	 * @return Returns the list of invocation sequences.
	 */
	List<InvocationSequenceData> getBufferInvocationSequenceInstances(long platformId, long methodId, int limit, Date fromDate, Date toDate, Comparator<? super InvocationSequenceData> comparator);
