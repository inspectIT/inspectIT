...
public class RegistrationService implements IRegistrationService {
	...
	public long registerJmxSensorTypeIdent(long platformId, String fullyQualifiedClassName) {
		...
		List<JmxSensorTypeIdent> jmxSensorTypeIdents = jmxSensorTypeIdentDao.findByExample(jmxSensorTypeIdent);
	...
	@Transactional
	@MethodLog
	public long registerJmxSensorDefinitionData(long platformId, String mBeanObjectName, String mBeanAttributeName, String mBeanAttributeDescription, String mBeanAttributeType, boolean isIs, // NOCHK
