...
public class ConfigurationInterfaceManager {
	 ...
	 */
	public Profile updateProfile(Profile profile) throws BusinessException, JAXBException, IOException {
	 ...
	 */
	public Environment updateEnvironment(Environment environment, boolean checkProfiles) throws BusinessException, JAXBException, IOException {
		if (checkProfiles) {
	 ...
	 */
	public AgentMappings setAgentMappings(AgentMappings agentMappings, boolean checkEnvironments) throws BusinessException, JAXBException, IOException {
		// check environment
