...
import info.novatec.inspectit.cmr.util.CollectionSubtractUtils;
...
public class EnvironmentUpdateEvent extends ApplicationEvent {
	...
	private Collection<? extends AbstractClassSensorAssignment<?>> getFunctionalAssignmentsDifference(SpecialMethodSensorAssignmentFactory factory, Environment e1, Environment e2) {
		Collection<SpecialMethodSensorAssignment> functionalAssignments1 = factory.getFunctionalAssignments(e1);
		Collection<SpecialMethodSensorAssignment> functionalAssignments2 = factory.getFunctionalAssignments(e2);
