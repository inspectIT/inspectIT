...
/**
 * The logging hook for log4j logging capturing. This hook captures all loggings
 * from log4j if the loggings are with a level "greater" than the provided
 * minimum logging level (see {@link SeverityHelper}).
 * 
 * If the minimum logging level is not provided or cannot be found in log4j
 * default levels, the logging hook will not capture any loggings.
 * 
 ...
 * t)</code> of the class <code>org.apache.log4j.Priority</code>. Putting this
 * hook to other classes/methods can lead to errors.
 * 
 * @author Stefan Siegl
 */
public class Log4JLoggingHook implements IMethodHook {
	...
	public Log4JLoggingHook(IIdManager idManager, String minimumLevelToCapture) {
		...
		if (!checker.isValid()) {
			LOG.warn("The configured minimum logging severity " + minimumLevelToCapture
					+ " is not found for the technology log4j. No logging will be captured. Defined levels are "
					+ checker.getOrderedLevels());
	 ...
	 * {@inheritDoc}
	 */
	public void beforeBody(long methodId, long sensorTypeId, Object object, Object[] parameters,
	 ...
	 * {@inheritDoc}
	 */
	public void firstAfterBody(long methodId, long sensorTypeId, Object object, Object[] parameters, Object result,
			RegisteredSensorConfig rsc) {
		// not needed for this hook
	}
	 ...
	 * {@inheritDoc}
	 */
	public void secondAfterBody(ICoreService coreService, long methodId, long sensorTypeId, Object object,
			Object[] parameters, Object result, RegisteredSensorConfig rsc) {
