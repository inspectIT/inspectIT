 ...
 * {@link RemoteApacheHttpClientV43InserterHook} class.
 * 
 * @author Thomas Kluge
 * 
 */
public class RemoteApacheHttpClientV43InserterSensor extends AbstractMethodSensor implements IMethodSensor {
	 ...
	 */
	public RemoteApacheHttpClientV43InserterSensor() {
	 ...
	 */
	public RemoteApacheHttpClientV43InserterSensor(IdManager idManager, RemoteIdentificationManager remoteIdentificationManager) {
	...
	public void init(Map<String, Object> parameters) {
		hook = new RemoteApacheHttpClientV43InserterHook(idManager, remoteIdentificationManager);
	}
