 ...
 * {@link WebrequestApacheHttpInserterHook} class.
 * 
 * @author Thomas Kluge
 * 
 */
public class WebrequestApacheHttpInserterSensor extends AbstractMethodSensor implements IMethodSensor {
	 ...
	 */
	public WebrequestApacheHttpInserterSensor() {
	 ...
	 */
	public WebrequestApacheHttpInserterSensor(IdManager idManager, Timer timer, RemoteIdentificationManager remoteIdentificationManager) {
	...
	public void init(Map<String, Object> parameters) {
		hook = new WebrequestApacheHttpInserterHook(idManager, timer, remoteIdentificationManager, ManagementFactory.getThreadMXBean());
	}
