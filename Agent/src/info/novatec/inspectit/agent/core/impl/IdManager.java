...
/**
 * New id manager that only holds the platform ident id and performs simple registration on the
 * start-up.
 *
 * @author Ivan Senic
 *
...
public class IdManager implements IIdManager, InitializingBean {
	...
	public long getRegisteredMethodId(long methodId) throws IdNotAvailableException {
		// TODO Remove this later, use given id
		return methodId;
	}
	 ...
	 * {@inheritDoc}
	 * <p>
	 * Just return given mBean id, there's no difference any more.
	 */
