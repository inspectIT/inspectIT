...
public interface IIdManager {
	...
	/**
	 * Registers a JmxDefinitionData and returns an unique id for it.
	 * @param config
	 * 		The jmx sensor type configuration which contains all the needed information for
	 *            registering.
	 * @return The unique jmx definitiondata id
	 */
	long registerJmxDefinitionDataIdent(JmxSensorConfig config);
