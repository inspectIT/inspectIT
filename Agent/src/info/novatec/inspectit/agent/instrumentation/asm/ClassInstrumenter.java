...
public class ClassInstrumenter extends ClassVisitor {
	 ...
	 */
	Collection<MethodInstrumentationConfig> appliedInstrumentationConfigs = new ArrayList<MethodInstrumentationConfig>(0);
	 ...
	 */
	public ClassInstrumenter(ClassVisitor classVisitor, Collection<MethodInstrumentationConfig> registeredSensorConfigs) {
		super(Opcodes.ASM5, classVisitor);
		this.instrumentationConfigs = new ArrayList<MethodInstrumentationConfig>(registeredSensorConfigs);
	}
