...
public class ReflectionCache {
	...
	public Object invokeMethod(Class<?> clazz, String methodName, Class<?>[] parameterTypes, Object instance, Object[] values, Object errorValue) {
		...
		try {
			if (parameterTypes == null || parameterTypes.length == 0) {
				return methodTuple.getMethodAccess().invoke(instance, methodTuple.getMethodIndex());
			} else {
				return methodTuple.getMethodAccess().invoke(instance, methodTuple.getMethodIndex(), values);
			}
