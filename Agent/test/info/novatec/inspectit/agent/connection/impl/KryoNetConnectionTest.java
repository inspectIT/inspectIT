...
public class KryoNetConnectionTest {
	...
	public static class KeepAlive extends KryoNetConnectionTest {
		...
		@Test
		public void keepAlive() throws ServerUnavailableException {
			long id = 3L;
		...
		public void timeout() throws ServerUnavailableException {
		...
		@Test(expectedExceptions = { ServerUnavailableException.class })
		public void remoteException() throws ServerUnavailableException {
	...
	public static class SendData extends KryoNetConnectionTest {
		...
		@Test
		public void sendData() throws ServerUnavailableException {
	...
	public static class RegisterPlatform extends KryoNetConnectionTest {
		...
		@Test
		public void register() throws ServerUnavailableException, BusinessException, RegistrationException {
			long id = 3L;
			...
			assertThat(connection.registerPlatform(agentName, version), is(id));
		...
		@Test(expectedExceptions = { ServerUnavailableException.class })
		public void timeout() throws ServerUnavailableException, BusinessException, RegistrationException {
		...
		@Test(expectedExceptions = { ServerUnavailableException.class })
		public void remoteException() throws ServerUnavailableException, BusinessException, RegistrationException {
		...
		public void businessException() throws ServerUnavailableException, BusinessException, RegistrationException {
	...
	public static class UnregisterPlatform extends KryoNetConnectionTest {
		...
		@Test
		public void unregister() throws ServerUnavailableException, BusinessException, RegistrationException {
			String agentName = "agentName";
	...
	public static class RegisterMethod extends KryoNetConnectionTest {
		...
		@Test
		public void registerMethod() throws ServerUnavailableException, RegistrationException {
			long id = 3L;
			...
			assertThat(connection.registerMethod(platformIdent, sensorConfig), is(id));
	...
	public static class RegisterMethodSensor extends KryoNetConnectionTest {
		...
		public void registerMethodSensor() throws ServerUnavailableException, RegistrationException {
			...
			assertThat(connection.registerMethodSensorType(platformIdent, methodSensorTypeConfig), is(id));
	...
	public static class RegisterPlatformSensor extends KryoNetConnectionTest {
		...
		@Test
		public void registerPlatformSensor() throws ServerUnavailableException, RegistrationException {
			long id = 3L;
			long platformIdent = 7L;
			...
			assertThat(connection.registerPlatformSensorType(platformIdent, platformSensorTypeConfig), is(id));
	...
	public static class AddSensorToMethod extends KryoNetConnectionTest {
		...
		@Test
		public void addSensorToMethod() throws ServerUnavailableException, RegistrationException {
			long methodId = 3L;
			long sensorId = 7L;
