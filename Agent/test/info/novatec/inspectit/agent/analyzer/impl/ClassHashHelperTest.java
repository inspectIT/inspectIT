...
public class ClassHashHelperTest extends TestBase {
	...
	@InjectMocks
	protected ClassHashHelper helper;
	...
	@Mock
	protected PrototypesProvider prototypesProvider;
	...
	public void setup() {
		...
		doReturn(new File(TEST_CACHE_FILE)).when(helper).getCacheFile();
	...
	public class Initialization extends ClassHashHelperTest {
		...
		public void initialInstrumentationPoints() throws Exception {
			...
			Map<Collection<String>, InstrumentationResult> initInstrumentations = Collections.<Collection<String>, InstrumentationResult> singletonMap(Collections.singleton(hash),
	...
	public class RegisterSent extends ClassHashHelperTest {
		...
		public void sent() throws Exception {
			...
			InstrumentationResult instrumentationResult = helper.getInstrumentationResult(hash);
