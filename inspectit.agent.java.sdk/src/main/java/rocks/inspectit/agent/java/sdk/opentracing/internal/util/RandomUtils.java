...
public final class RandomUtils {
	...
	public static long randomLong() {
		...
		return ((randomBytes[0] & 0xffL) << 56) | ((randomBytes[1] & 0xffL) << 48) | ((randomBytes[2] & 0xffL) << 40) | ((randomBytes[3] & 0xffL) << 32) | ((randomBytes[4] & 0xffL) << 24)
				| ((randomBytes[5] & 0xffL) << 16) | ((randomBytes[6] & 0xffL) << 8) | (randomBytes[7] & 0xffL);
	}
