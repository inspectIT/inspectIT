...
public class SpanImpl implements Span {
	...
	/**
	 * Start time of the span. Microseconds since epoh.
	 */
	 ...
	 * the nano fraction when possible the
	 */
	...
	public String toString() {
		return "SpanImpl [spanContext=" + this.spanContext + ", operationName=" + this.operationName + ", duration=" + this.duration + "]";
	}
