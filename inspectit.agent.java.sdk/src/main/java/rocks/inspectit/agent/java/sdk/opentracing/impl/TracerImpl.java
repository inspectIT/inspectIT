...
import rocks.inspectit.agent.java.sdk.opentracing.propagation.TextMapPropagator;
import rocks.inspectit.agent.java.sdk.opentracing.propagation.UrlEncodingPropagator;
 ...
 * a span is stared it will be added to the current thread span stack. Every time span is finished
 * it will be removed form the thread stack.
 * <p>
...
public class TracerImpl implements ExtendedTracer {
	 ...
	 * {@link TracerImpl#TracerImpl(Timer, Reporter, false)} for initialization with reporter of
	 * your choice.
	 */
	public TracerImpl() {
