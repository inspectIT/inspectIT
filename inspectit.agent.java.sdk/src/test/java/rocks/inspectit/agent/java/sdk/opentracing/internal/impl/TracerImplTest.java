...
public class TracerImplTest extends TestBase {
	...
	@BeforeMethod
	public void init() {
		tracer = new TracerImpl(timer, reporter, logger, false);
	}
	...
	public static class Constructor extends TracerImplTest {
		...
		public void setToProvider() {
			tracer = new TracerImpl(timer, reporter, logger, true);
		...
		public void nullTimer() {
			new TracerImpl(null, reporter, logger, false);
		}

		@Test(expectedExceptions = IllegalArgumentException.class)
		public void nullReporter() {
			new TracerImpl(timer, null, logger, false);
		}

		@Test(expectedExceptions = IllegalArgumentException.class)
		public void nullLogger() {
			new TracerImpl(timer, reporter, null, false);
		}
	}
	...
	public static class SpanEnded extends TracerImplTest {
		...
		public void twoSpansFirstEndsBeforeSecond() {
			...
			verifyNoMoreInteractions(reporter, logger);
		}
