...
The integration is as simple as changing the startup of your application.

```
java -Xbootclasspath/p:[INSPECTIT_AGENT_HOME]/inspectit-agent.jar -javaagent:.../inspectit-agent.jar -Dinspectit.config=[INSPECTIT_CONFIG_HOME] ...
```
