...
public class CmrRepositoryPropertyForm implements ISelectionChangedListener {
	...
	private void initWidget() {
		...
		Section externalServices = toolkit.createSection(mainComposite, ExpandableComposite.TITLE_BAR);
		externalServices.setText("External services");

		Composite externalServicesSectionComposite = toolkit.createComposite(externalServices, SWT.NONE);
		...
		externalServices.setClient(externalServicesSectionComposite);
		externalServices.setLayout(new TableWrapLayout());
		externalServices.setLayoutData(new TableWrapData(TableWrapData.FILL_GRAB));
