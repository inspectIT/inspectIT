...
public class InstrumentationUpdateDialog extends TitleAreaDialog {
	 ...
	 */
	public InstrumentationUpdateDialog(Shell parentShell, Map<PlatformIdent, AgentStatusData> pendingAgents, String closeButtonLabel) {
		super(parentShell);
		this.pendingAgents = pendingAgents;
	...
	protected Control createDialogArea(Composite parent) {
		...
		buttonSelectAllAgents.setSelection(true);
