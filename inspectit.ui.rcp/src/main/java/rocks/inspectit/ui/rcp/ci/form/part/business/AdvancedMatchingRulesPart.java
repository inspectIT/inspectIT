...
import rocks.inspectit.ui.rcp.ci.DelegatingManagedForm;
 ...
 *
 */
public class AdvancedMatchingRulesPart extends MasterDetailsBlock implements IMatchingRulesPart, ISelectionChangedListener, IDetailsModifiedListener<AbstractExpression>, DisposeListener {
	...
	private class DelegatingValidationManager extends AbstractValidationManager<AbstractExpression> implements IControlValidationListener {
		...
		public void validationStateChanged(boolean valid, ValidationControlDecoration<?> validationControlDecoration) {
			delegateTo.validationStateChanged(new MatchingRulesEditingElementFactory.InvalidExpression(), new ValidationState("emptyTree", valid, validationControlDecoration.getDescriptionText()));
		}
