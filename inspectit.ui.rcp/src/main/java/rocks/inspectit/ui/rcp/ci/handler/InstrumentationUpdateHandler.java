...
public class InstrumentationUpdateHandler extends AbstractHandler implements IHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		execute(cmrRepositoryDefinition, true);
	 ...
	 */
	public static void execute(CmrRepositoryDefinition cmrRepositoryDefinition) {
		execute(cmrRepositoryDefinition, false);
	}
	 ...
	 *            opening
	 */
	private static void execute(final CmrRepositoryDefinition repositoryDefinition, final boolean forceDialog) {
				...
				if (forceDialog || (saveBehavior != OnSaveBehavior.DO_NOTHING)) {
					...
					if (forceDialog || (saveBehavior == OnSaveBehavior.SHOW_DIALOG)) {
						if (forceDialog || ((agentMap != null) && !agentMap.isEmpty())) {
							...
							InstrumentationUpdateDialog updateDialog = new InstrumentationUpdateDialog(shell, agentMap);
