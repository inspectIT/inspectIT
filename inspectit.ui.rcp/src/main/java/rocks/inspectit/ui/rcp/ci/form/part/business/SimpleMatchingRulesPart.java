...
public class SimpleMatchingRulesPart extends SectionPart implements IMatchingRulesPart, IControlValidationListener {
	...
	public void createContent(IManagedForm managedForm, Composite parent) {
		...
		// add initial dummy element to ruleElements to avoid initial validation to be always
		// invalid.
		ruleElements.add(null);
		listValidation = new ValidationControlDecoration<Label>(descriptionLabel, this) {
