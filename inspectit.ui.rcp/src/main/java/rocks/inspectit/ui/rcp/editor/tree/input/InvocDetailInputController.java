...
public class InvocDetailInputController extends AbstractTreeInputController { // NOPMD
	...
	public void setInputDefinition(InputDefinition inputDefinition) {
		...
		IInvocationDataAccessService invocationDataAccessService = inputDefinition.getRepositoryDefinition().getInvocationDataAccessService();
	...
	public boolean canOpenInput(List<? extends Object> data) {
		...
		if (inputObject instanceof Span) {
			return true;
