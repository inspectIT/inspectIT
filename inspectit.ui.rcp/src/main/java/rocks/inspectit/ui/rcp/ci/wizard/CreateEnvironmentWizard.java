...
public class CreateEnvironmentWizard extends Wizard implements INewWizard {
	...
	public void addPages() {
		...
		defineNameAndDescriptionWizardPage = new DefineNameAndDescriptionWizardPage(TITLE, MESSAGE, Environment.convertEnvironmentListToNameStringList(environments));
