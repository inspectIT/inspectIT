...
public enum SensorTypeAvailabilityEnum {
	 ...
	 */
	CLASS_INF_NA("This item is not available. You have to activate the 'ClassLoadingSensor' platform sensor type in 'inspectit-agent.cfg' for viewing this information."),
	 ...
	 */
	JMX_SENSOR_NA("This item is not available. You have to activate the jmx sensor in 'inspectit-agent.cfg' for viewing this information.");
