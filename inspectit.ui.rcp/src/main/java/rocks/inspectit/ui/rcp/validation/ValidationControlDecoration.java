...
public abstract class ValidationControlDecoration<T extends Control> {
	 ...
	 *            Control to decorate.
	 * @param listener
	 *            {@link IControlValidationListener}. * @param startupValidation Defines whether the
	 *            control shall be validated during construction of the ValidationControlDecoration.
	 */
