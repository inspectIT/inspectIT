...
public class JAXBTransformatorTest extends TestBase {
	...
	public static class Unmarshal extends JAXBTransformatorTest {
		...
		public void schemaVersionUpToDate() throws Exception {
			...
			TestData unmarshalled = transformator.unmarshall(path, schemaPath, schemaVersion, migrationPath, true, TestData.class);
		...
		public void schemaVersionNotUpToDate() throws Exception {
			...
			TestData unmarshalled = transformator.unmarshall(path, schemaPath, schemaVersion + 1, migrationPath, true, TestData.class);
		...
		@Test
		public void schemaVersionNotUpToDateNoRewriting() throws Exception {
			int schemaVersion = 0;
			String value = "value";
			TestData testData = new TestData();
			testData.setValue(value);
			...
			transformator.unmarshall(path, schemaPath, schemaVersion + 1, migrationPath, false, TestData.class);

			assertThat(Files.readAllLines(path, Charset.defaultCharset()), is(update));
		}
