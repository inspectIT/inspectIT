...
import rocks.inspectit.shared.cs.instrumentation.config.applier.MethodSensorInstrumentationApplier;
import rocks.inspectit.shared.cs.instrumentation.config.filter.AssignmentFilterProvider;
import rocks.inspectit.shared.cs.instrumentation.config.filter.ClassSensorAssignmentFilter;
import rocks.inspectit.shared.cs.instrumentation.config.filter.MethodSensorAssignmentFilter;
