...
public class SpecialMethodSensorAssignmentFactoryTest extends TestBase {
	...
	public class GetSpecialAssignments extends SpecialMethodSensorAssignmentFactoryTest {
		...
		public void noSpecialAssignment() {
			...
			assertThat("There must be at least three items in special sensor: HttpClientBuilder and CloseableHttpAsyncClient", assignments, everyItem(hasProperty("specialMethodSensorConfig",
		...
		public void classLoadingDelegation() {
			...
			assertThat("Must be at least one classLoadingDelegationAssignment in the special sensors", assignments,
					everyItem(hasProperty("specialMethodSensorConfig", anyOf(is(ClassLoadingDelegationSensorConfig.INSTANCE), is(ExecutorIntercepterSensorConfig.INSTANCE),
							is(HttpClientBuilderSensorConfig.INSTANCE), is(CloseableHttpAsyncClientSensorConfig.INSTANCE)))));
		}
		...
		public void mbeanServer() {
			...
			assertThat(assignments, is(not(empty())));
			assertThat("Must be at least one mbeanServerInterceptorAssignments in the special sensors", assignments,
					everyItem(hasProperty("specialMethodSensorConfig", anyOf(is(MBeanServerInterceptorSensorConfig.INSTANCE), is(ExecutorIntercepterSensorConfig.INSTANCE),
							is(HttpClientBuilderSensorConfig.INSTANCE), is(CloseableHttpAsyncClientSensorConfig.INSTANCE)))));
		}
		...
		public void endUserMonitoring() {
			...
			assertThat(assignments, is(not(empty())));
			assertThat("Must be at least one EUMInstrumentation in the special sensors", assignments,
					everyItem(hasProperty("specialMethodSensorConfig", anyOf(is(ExecutorIntercepterSensorConfig.INSTANCE), is(EUMInstrumentationSensorConfig.INSTANCE),
							is(HttpClientBuilderSensorConfig.INSTANCE), is(CloseableHttpAsyncClientSensorConfig.INSTANCE)))));
		}
		...
		public void executorClientProfilesNotLoaded() {
			...
			assertThat(assignments, hasSize(3));
			assertThat(assignments, hasItem(hasProperty("specialMethodSensorConfig", is(ExecutorIntercepterSensorConfig.INSTANCE))));
			assertThat(assignments, hasItem(hasProperty("specialMethodSensorConfig", is(HttpClientBuilderSensorConfig.INSTANCE))));
			assertThat(assignments, hasItem(hasProperty("specialMethodSensorConfig", is(CloseableHttpAsyncClientSensorConfig.INSTANCE))));
		}
		...
		public void httpClientBuilderSensorIsActive() {
			...
			assertThat(assignments, is(not(empty())));
			assertThat("Must be at least one HttpClientBuilder in the special sensors", assignments, hasItem(hasProperty("specialMethodSensorConfig", is(HttpClientBuilderSensorConfig.INSTANCE))));
		}
		...
		public void closeableHttpAsyncClientSensorIsActive() {
			...
			assertThat(assignments, is(not(empty())));
			assertThat("Must be at least one CloseableHttpAsyncClient in the special sensors", assignments,
					hasItem(hasProperty("specialMethodSensorConfig", is(CloseableHttpAsyncClientSensorConfig.INSTANCE))));
		}
	}
}
