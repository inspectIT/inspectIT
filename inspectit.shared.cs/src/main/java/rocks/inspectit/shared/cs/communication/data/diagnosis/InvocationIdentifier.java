...
public class InvocationIdentifier {
	...
	private final TimerDataProblemOccurrence timerDataProblemOccurrence;
	...
	public InvocationIdentifier(final InvocationSequenceData invocationSequenceData) {
		...
		this.timerDataProblemOccurrence = new TimerDataProblemOccurrence(InvocationSequenceDataHelper.getTimerDataOrSQLData(invocationSequenceData));
	}
