...
public interface IConfigurationInterfaceService {
	 ...
	 *             If operation fails.
	 */
	byte[] getExportData(ConfigurationInterfaceExportData exportData) throws BusinessException;
	 ...
	 *             If operation fails.
	 */
	ConfigurationInterfaceExportData getImportData(byte[] importData) throws BusinessException;
